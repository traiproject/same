...
func setupCacheBypassTest(t *testing.T, rebuildStrategy domain.RebuildStrategy, noCache bool) {
	t.Helper()
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestScheduler_RebuildStrategy(t *testing.T) {
	t.Run("RebuildAlways bypasses cache", func(t *testing.T) {
		synctest.Test(t, func(t *testing.T) {
			setupCacheBypassTest(t, domain.RebuildAlways, false)
		})
	})

	t.Run("noCache flag bypasses cache", func(t *testing.T) {
		synctest.Test(t, func(t *testing.T) {
			setupCacheBypassTest(t, domain.RebuildOnChange, true)
		})
	})
